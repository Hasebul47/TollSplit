...
class DeviceRepository(private val db: FirebaseFirestore = FirebaseFirestore.getInstance()) {
    ...
    suspend fun registerDevice(deviceId: String, userName: String) {
    ...
    suspend fun updateDeviceBanStatus(deviceId: String, isBanned: Boolean) {
    ...
    suspend fun updateDeviceUserName(deviceId: String, userName: String) {
